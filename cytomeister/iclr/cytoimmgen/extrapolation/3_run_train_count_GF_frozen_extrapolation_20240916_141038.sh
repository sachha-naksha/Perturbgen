...
source /lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/.torch25/bin/activate
cwd=$(pwd)
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen_extrapolation/checkpoints/20240916_1125_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_512_mlmp_0.15_tp_1-2_s_42-epoch=49.ckpt" \
