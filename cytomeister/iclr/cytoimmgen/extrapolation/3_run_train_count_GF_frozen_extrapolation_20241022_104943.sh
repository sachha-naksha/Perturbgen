...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/extrapolation/res/checkpoints/20240929_0015_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1-2_s_100-epoch=09.ckpt" \
