...
#BSUB -o logs/count_GF_frozen_pow_learnt_%J.out # output file
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/masking_scheduler/res/checkpoints/20240927_0051_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_psin_learnt_m_pow_tp_1-3_s_42-epoch=09.ckpt" \
