...
#BSUB -gpu 'mode=exclusive_process:num=1:block=yes:gmodel=NVIDIAA100_SXM4_80GB' # request for exclusive access to gpu (:gmodel=NVIDIAA100_SXM4_80GB if you want to specify the gpu model)
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/masking_scheduler/res/checkpoints/20240920_1725_mask_log_train_masking_lr_0.0001_wd_0.0001_batch_64_mlmp_0.15_tp_1-3_s_42-epoch=09.ckpt" \
