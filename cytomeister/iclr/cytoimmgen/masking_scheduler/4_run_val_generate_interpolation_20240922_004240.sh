...
--generate True \
--ckpt_count_path './T_perturb/cytomeister/iclr/cytoimmgen/masking_scheduler/res/checkpoints/20240921_1242_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-3_s_42_mask_uniform-epoch=01.ckpt' \
