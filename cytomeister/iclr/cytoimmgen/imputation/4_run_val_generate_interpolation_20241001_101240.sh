...
#BSUB -o logs/cyto_generate_imputation_%J.out # output file
#BSUB -e logs/cyto_generate_imputation_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J cytoimmgen_generate_imputation # job name
...
--generate True \
--ckpt_count_path './T_perturb/cytomeister/iclr/cytoimmgen/imputation/res/checkpoints/20241001_0918_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-2-3_s_42_pos_sin_learnt_m_cosine-epoch=01.ckpt' \
