...
#BSUB -o logs/sdpa_count_GF_frozen_%J.out # output file
#BSUB -e logs/sdpa_count_GF_frozen_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J sdpa_cytoimmgen_count_GF_frozen # job name
...
cp $0 $RES_DIR/$RES_NAME/sdpa_run_train_count_GF_frozen_interpolation_$TIMESTAMP.sh
echo "Copying script to $RES_DIR/$RES_NAME/sdpa_run_train_count_GF_frozen_interpolation_$TIMESTAMP.sh"
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/sdpa_ablation/checkpoints/20240916_0728_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_256_mlmp_0.15_tp_1-3_s_42-epoch=09.ckpt" \
