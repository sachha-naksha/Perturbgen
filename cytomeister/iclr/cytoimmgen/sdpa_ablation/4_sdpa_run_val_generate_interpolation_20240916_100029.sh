...
cp $0 $RES_DIR/$RES_NAME/sdpa_run_val_generate_interpolation_$TIMESTAMP.sh
echo "Copying script to $RES_DIR/$RES_NAME/sdpa_val_generate_interpolation_$TIMESTAMP.sh"
...
--generate True \
--ckpt_count_path './T_perturb/cytomeister/iclr/sdpa_ablation/checkpoints/20240916_0755_normal_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-3_s_42-epoch=09.ckpt' \
