...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/interpolation/res/checkpoints/20240927_1827_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_psin_learnt_m_cosine_tp_1-3_s_42-epoch=39.ckpt" \
