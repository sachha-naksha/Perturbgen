...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/positional_encoding/res/checkpoints/20240927_0054_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_64_ptime_pos_sin_m_cosine_tp_1-3_s_42-epoch=09.ckpt" \
