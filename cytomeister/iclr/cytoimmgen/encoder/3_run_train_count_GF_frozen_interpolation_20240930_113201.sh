...
#BSUB -o logs/count_inter_gf_fine_tuned_%J.out # output file
#BSUB -e logs/count_inter_gf_fine_tuned_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J cytoimmgen_count_inter_gf_fine_tuned # job name
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/encoder/res/checkpoints/20240930_0101_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_psin_learnt_m_cosine_tp_1-3_s_42-epoch=09.ckpt" \
