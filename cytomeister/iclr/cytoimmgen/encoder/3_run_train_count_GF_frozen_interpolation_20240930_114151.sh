...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/encoder/res/checkpoints/20240930_0101_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_psin_learnt_gf_finetuned_s_42-epoch=09.ckpt" \
