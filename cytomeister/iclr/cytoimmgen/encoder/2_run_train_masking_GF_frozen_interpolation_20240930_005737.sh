...
#BSUB -o logs/cytoimmgen_masking_gf_fine_tuned_%J.out # output file
#BSUB -e logs/cytoimmgen_masking_gf_fine_tuned_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J cytoimmgen_masking_gf_fine_tuned # job name
