...
#BSUB -o logs/cyto_generate_s100_%J.out # output file
#BSUB -e logs/cyto_generate_s100_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J cytoimmgen_generate_s100 # job name
...
--generate True \
--ckpt_count_path './T_perturb/cytomeister/iclr/cytoimmgen/interpolation/res/checkpoints/20240929_1000_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-3_s_100_pos_sin_learnt_m_cosine-epoch=01.ckpt' \
