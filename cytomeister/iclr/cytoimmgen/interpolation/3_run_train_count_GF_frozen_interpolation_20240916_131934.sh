...
#BSUB -o logs/count_GF_frozen_%J.out # output file
#BSUB -e logs/count_GF_frozen_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J cytoimmgen_count_GF_frozen # job name
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen_interpolation/checkpoints/20240916_1100_cellgen_train_masking_lr_0.0001_wd_0.0001_batch_512_mlmp_0.15_tp_1-3_s_42-epoch=49.ckpt" \
