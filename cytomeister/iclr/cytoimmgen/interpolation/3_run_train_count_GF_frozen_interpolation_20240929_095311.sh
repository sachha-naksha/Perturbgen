...
#BSUB -o logs/count_GF_frozen_s100_%J.out # output file
#BSUB -e logs/count_GF_frozen_s100_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J cytoimmgen_count_GF_frozen_s100 # job name
...
--ckpt_masking_path "./T_perturb/cytomeister/iclr/cytoimmgen/interpolation/res/checkpoints/20240929_0015_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_psin_learnt_m_cosine_tp_1-3_s_100-epoch=09.ckpt" \
