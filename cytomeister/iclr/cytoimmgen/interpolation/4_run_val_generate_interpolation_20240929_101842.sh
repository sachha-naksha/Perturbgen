...
--generate True \
--ckpt_count_path './T_perturb/cytomeister/iclr/cytoimmgen/interpolation/res/checkpoints/20240929_1000_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-3_s_0_pos_sin_learnt_m_cosine-epoch=01.ckpt' \
