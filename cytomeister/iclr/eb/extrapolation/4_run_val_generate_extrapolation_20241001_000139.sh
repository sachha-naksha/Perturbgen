...
--ckpt_count_path './T_perturb/cytomeister/iclr/eb/extrapolation/res/checkpoints/20240930_2350_cellgen_train_count_lr_0.0001_wd_0.0001_batch_64_zinb_tp_1-2_s_0_pos_sin_learnt_m_cosine-epoch=99.ckpt' \
