...
#BSUB -o logs/eb_count_extra_s0_%J.out # output file
#BSUB -e logs/eb_count_extra_s0_%J.err # error file
#BSUB -M 20000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>20000] rusage[mem=20000]' # RAM memory part 1. Default: 100MB
#BSUB -J eb_count_extra_s0 # job name
...
--ckpt_masking_path './T_perturb/cytomeister/iclr/eb/extrapolation/res/checkpoints/20240930_2329_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1-2_s_0-epoch=49.ckpt' \
