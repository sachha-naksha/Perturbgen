...
--ckpt_masking_path './T_perturb/cytomeister/iclr/eb/interpolation/res/checkpoints/20240930_2328_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1-2-4_s_0-epoch=49.ckpt' \
