...
#BSUB -o logs/eb_count_inter_s100_%J.out # output file
#BSUB -e logs/eb_count_inter_s100_%J.err # error file
#BSUB -M 20000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>20000] rusage[mem=20000]' # RAM memory part 1. Default: 100MB
#BSUB -J eb_count_inter_s100 # job name
...
--ckpt_masking_path './T_perturb/cytomeister/iclr/eb/interpolation/res/checkpoints/20240930_2328_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1-2-4_s_100-epoch=49.ckpt' \
