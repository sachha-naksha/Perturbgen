...
#BSUB -J eb_count_extra_cont_generation # job name
...
--ckpt_masking_path './T_perturb/cytomeister/iclr/eb/continuous_generation/res/checkpoints/20241002_0853_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_psin_learnt_m_cosine_tp_1_s_42-epoch=49.ckpt' \
