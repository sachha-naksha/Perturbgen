...
--ckpt_count_path 'T_perturb/cytomeister/plt/res/lps/pbmc_median/extrapolation/res/checkpoints/20250513_1751_cellgen_train_count_lr_0.001_wd_0.0001_batch_64_zinb_tp_1-2_s_42_pos_time_pos_sin_m_pow-epoch=04.ckpt' \
