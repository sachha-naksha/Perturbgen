...
--ckpt_masking_path "T_perturb/res/hspc/fine_tuning/checkpoints/20250709_1149_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_pow_tp_1_s_42-epoch=19.ckpt" \
--context_mode False \
--mask_scheduler 'pow' \
