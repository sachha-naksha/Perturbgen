...
--ckpt_masking_path "T_perturb/cytomeister/res/hspc/_median/checkpoints/20250325_1751_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_pow_tp_1-2_s_42-epoch=19.ckpt" \
--context_mode True \
--mask_scheduler 'pow' \
