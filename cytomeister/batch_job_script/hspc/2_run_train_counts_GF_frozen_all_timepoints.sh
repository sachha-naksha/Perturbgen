...
--src_adata "T_perturb/tokenized_data/hspc_pbmc_median/h5ad_pairing_10000_hvg_src/stem.h5ad" \
--tgt_adata_folder "T_perturb/tokenized_data/hspc_pbmc_median/h5ad_pairing_10000_hvg_tgt" \
...
--ckpt_masking_path "T_perturb/res/hspc/checkpoints/20250325_1751_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_pow_tp_1-2_s_42-epoch=19.ckpt" \
--context_mode True \
--mask_scheduler 'pow' \
