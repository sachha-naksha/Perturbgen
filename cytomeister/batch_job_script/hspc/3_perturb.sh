...
#BSUB -o T_perturb/cytomeister/logs/perturb_cluster_B2M_%J.out # output file
#BSUB -e T_perturb/cytomeister/logs/perturb_cluster_B2M_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J hspc_perturb_cluster_B2M # job name
...
--config /lustre/scratch126/cellgen/lotfollahi/kl11/T_perturb/cytomeister/configs/eval/HSPC/mask_src_inference_perturbation_B2M.yaml
