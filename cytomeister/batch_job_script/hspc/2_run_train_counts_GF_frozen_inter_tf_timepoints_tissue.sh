...
--ckpt_masking_path "T_perturb/cytomeister/res/hspc/fine_tuning/checkpoints/20250624_1010_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_pow_tp_1_s_42-epoch=24.ckpt" \
--context_mode False \
--mask_scheduler 'pow' \
