...
--src_dataset "T_perturb/cytomeister/pp/res/hspc_pbmc_median_inter_tissue_5k/dataset_5000_hvg_src/intermediate.dataset" \
--tgt_dataset_folder "T_perturb/cytomeister/pp/res/hspc_pbmc_median_inter_tissue_5k/dataset_5000_hvg_tgt" \
--src_adata "T_perturb/cytomeister/pp/res/hspc_pbmc_median_inter_tissue_5k/h5ad_pairing_5000_hvg_src/intermediate.h5ad" \
--tgt_adata_folder "T_perturb/cytomeister/pp/res/hspc_pbmc_median_inter_tissue_5k/h5ad_pairing_5000_hvg_tgt" \
--mapping_dict_path  "T_perturb/cytomeister/pp/res/hspc_pbmc_median_inter_tissue_5k/token_id_to_genename_5000_hvg.pkl" \
--batch_size 64 \
--max_len 2450 \
--epochs 20 \
--tgt_vocab_size 5010 \
...
--ckpt_masking_path "T_perturb/cytomeister/res/hspc/_median/checkpoints/20250417_1613_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_pow_tp_1_s_42-epoch=19.ckpt" \
--context_mode True \
--mask_scheduler 'pow' \
