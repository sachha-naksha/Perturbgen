...
--src_dataset "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_5k/dataset_5000_hvg_src/intermediate.dataset" \
--tgt_dataset_folder "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_5k/dataset_5000_hvg_tgt" \
--src_adata "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_5k/h5ad_pairing_5000_hvg_src/intermediate.h5ad" \
--tgt_adata_folder "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_5k/h5ad_pairing_5000_hvg_tgt" \
--mapping_dict_path  "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_5k/token_id_to_genename_5000_hvg.pkl" \
--batch_size 64 \
--max_len 2450 \
--epochs 20 \
--tgt_vocab_size 5010 \
