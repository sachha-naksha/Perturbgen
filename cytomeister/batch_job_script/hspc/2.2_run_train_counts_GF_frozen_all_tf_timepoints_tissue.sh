...
--src_dataset "T_perturb/tokenized_data/hspc_pbmc_median_inter_tissue_all_tf_2/dataset_5000_hvg_src/stem.dataset" \
--tgt_dataset_folder "T_perturb/tokenized_data/hspc_pbmc_median_inter_tissue_all_tf_2/dataset_5000_hvg_tgt" \
--src_adata "T_perturb/tokenized_data/hspc_pbmc_median_inter_tissue_all_tf_2/h5ad_pairing_5000_hvg_src/stem.h5ad" \
