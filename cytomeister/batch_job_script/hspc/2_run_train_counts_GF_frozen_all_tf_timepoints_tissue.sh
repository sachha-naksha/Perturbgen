...
--src_dataset "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_all_tf/dataset_5000_hvg_src/stem.dataset" \
--tgt_dataset_folder "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_all_tf/dataset_5000_hvg_tgt" \
--src_adata "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_all_tf/h5ad_pairing_5000_hvg_src/stem.h5ad" \
--tgt_adata_folder "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_all_tf/h5ad_pairing_5000_hvg_tgt" \
--mapping_dict_path  "T_perturb/tokenized_datahspc_pbmc_median_inter_tissue_all_tf/token_id_to_genename_5000_hvg.pkl" \
--batch_size 64 \
--max_len 2943 \
--epochs 20 \
--tgt_vocab_size 5848 \
