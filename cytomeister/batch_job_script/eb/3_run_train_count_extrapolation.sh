...
--ckpt_masking_path 'T_perturb/T_perturb/plt/res/eb/pbmc_median/extrapolation/checkpoints/20250512_1603_cellgen_train_masking_lr_0.001_wd_0.0001_batch_64_ptime_pos_sin_m_pow_tp_1-2-3_s_0-epoch=49.ckpt' \
