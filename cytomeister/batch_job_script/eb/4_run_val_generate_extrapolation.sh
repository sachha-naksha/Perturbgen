...
--ckpt_count_path 'T_perturb/cytomeister/plt/res/eb/pbmc_median/extrapolation/res/checkpoints/20250512_1534_cellgen_train_count_lr_0.0001_wd_0.0001_batch_64_zinb_tp_1-2-3_s_42_pos_time_pos_sin_m_pow-epoch=69.ckpt' \
