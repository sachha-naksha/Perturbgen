...
class scmoscf(nn.Module):
    ...
    def forward(
        ...
        if self.training:
            src_input_id, labels = self.generate_mask(
                src_input_id,
                src_attention_mask,
            ...
            labels= None
        src_embedding = self.token_embedding(src_input_id)
        src_embedding = self.pos_embedding(src_embedding, 1)
