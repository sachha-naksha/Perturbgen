...
cp $0 $RES_DIR/$RES_NAME/run_train_masking_GF_frozen_interpolation_$TIMESTAMP.sh
echo "Copying script to $RES_DIR/$RES_NAME/run_train_masking_GF_frozen_interpolation_$TIMESTAMP.sh"
