...
#BSUB -J sdpa_cytoimmgen_count_GF_fine_tuned # job name
...
cp $0 $RES_DIR/$RES_NAME/sdpa_run_train_masking_GF_fine_tuned_interpolation_$TIMESTAMP.sh
echo "Copying script to $RES_DIR/$RES_NAME/sdpa_run_train_masking_GF_fine_tuned_interpolation_$TIMESTAMP.sh"
...
--ckpt_masking_path "./T_perturb/T_perturb/iclr/sdpa_ablation/checkpoints/20240915_1832_sdpa_train_masking_lr_0.0001_wd_0.0001_batch_512_mlmp_0.15_tp_1-3_s_42-epoch=09.ckpt" \
