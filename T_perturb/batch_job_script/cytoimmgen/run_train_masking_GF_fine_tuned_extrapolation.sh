...
#BSUB -o logs/random_pairing_stratified_pairing_masking_%J.out # output file
#BSUB -e logs/random_pairing_stratified_pairing_masking_%J.err # error file
...
# activate pyenv
source /lustre/scratch123/hgi/projects/healthy_imm_expr/t_generative/T_perturb/T_perturb/.torch25
cwd=$(pwd)
...
cp $0 $RES_DIR/$RES_NAME/run_train_masking_GF_fine_tuned_extrapolation_$TIMESTAMP.sh
echo "Copying script to $RES_DIR/$RES_NAME/run_train_masking_GF_fine_tuned_extrapolation_$TIMESTAMP.sh"
