...
#BSUB -o logs/hspc_perturb_%J.out # output file
#BSUB -e logs/hspc_perturb_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J hspc_perturb_generate # job name
...
--config T_perturb/T_perturb/configs/eval/HSPC/mask_src_generate_perturbation.yaml
