...
#BSUB -o T_perturb/logs/perturb_cluster_cl61_%J.out # output file
#BSUB -e T_perturb/logs/perturb_cluster_cl61_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J hspc_perturb_cluster_cl61 # job name
...
--config /lustre/scratch126/cellgen/team361/kl11/t_generative/T_perturb/T_perturb/configs/eval/HSPC/mask_tgt_inference_perturbation_cl61.yaml
