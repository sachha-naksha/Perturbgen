...
#BSUB -M 450000  # RAM memory part 2. Default: 100MB
#BSUB -R "select[mem>450000] rusage[mem=450000]" # RAM memory part 1. Default: 100MB
...
--return_attn False \
--generate False \
--ckpt_masking_path "T_perturb/T_perturb/plt/res/hspc/pbmc_median/checkpoints/20250117_1003_cellgen_train_masking_lr_1e-05_wd_1e-05_batch_64_ptime_pos_sin_m_cosine_tp_1-2_s_42-epoch=09.ckpt" \
