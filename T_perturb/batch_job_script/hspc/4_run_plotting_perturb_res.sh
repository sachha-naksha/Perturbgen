...
#BSUB -o T_perturb/T_perturb/logs/plt_perturb_res_GATA2_%J.out # output file
#BSUB -e T_perturb/T_perturb/logs/plt_perturb_res_GATA2_%J.err # error file
#BSUB -M 25000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>25000] rusage[mem=25000]' # RAM memory part 1. Default: 100MB
#BSUB -J plt_perturb_res_GATA2 # job name
...
--perturbed_gene 'GATA2' \
--p_perturbation 'T_perturb/T_perturb/plt/res/hspc/pbmc_median/perturbation/20250422-09:13_minference_adata_gGATA2_ssrc_tmask.h5ad' \
