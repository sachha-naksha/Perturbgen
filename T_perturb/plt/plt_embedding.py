...
adata_cls = sc.read_h5ad(
    f'{args.res_dir}/'
    '20240808_random_embs_generate_adata_extrapolate_'
    '[3]__Transformer_encoder_100_zinb_3.h5ad'
)
...
plt.savefig(
    f'{args.res_dir}/20240809_random_embeddings_umap_generate_s100_full.pdf',
    bbox_inches='tight',
)
plt.close()
