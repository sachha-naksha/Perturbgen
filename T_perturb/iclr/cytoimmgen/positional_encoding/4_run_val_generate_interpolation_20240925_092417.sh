...
--generate True \
--ckpt_count_path './T_perturb/T_perturb/iclr/cytoimmgen/positional_encoding/res/checkpoints/20240925_0808_cellgen_train_count_lr_0.005_wd_0.001_batch_64_zinb_tp_1-3_s_42_pos_time_pos_sin-epoch=02.ckpt' \
