...
#BSUB -o logs/eb_generate_inter_s0_%J.out # output file
#BSUB -e logs/eb_generate_inter_s0_%J.err # error file
#BSUB -M 50000  # RAM memory part 2. Default: 100MB
#BSUB -R 'select[mem>50000] rusage[mem=50000]' # RAM memory part 1. Default: 100MB
#BSUB -J eb_generate_inter_s0 # job name
...
--ckpt_count_path './T_perturb/T_perturb/iclr/eb/interpolation/res/checkpoints/20240930_2348_cellgen_train_count_lr_0.0001_wd_0.0001_batch_64_zinb_tp_1-2-4_s_0_pos_sin_learnt_m_cosine-epoch=99.ckpt' \
